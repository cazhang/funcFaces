function g = gwIcpGradDouble(X, Nsets, Ndims, NNbasis, NNInd)
...
%                     Vij = V1(:, dest2);
                    %Vjj = NNbasis(:,:,j,j);          
                    Vjj = NNbasis(:,NNInd{i,j}.src,j);
                    Vji = NNbasis(:,NNInd{i,j}.des,i);
                    %Vji = NNbasis(:,:,i,j);
                    %Vii = NNbasis(:,:,i,i);       
                    Vii = NNbasis(:,NNInd{j,i}.src,i);
                    Vij = NNbasis(:,NNInd{j,i}.des,j);
                    %Vij = NNbasis(:,:,j,i);
