function g = gwIcpGradGPA(X, Nsets, Ndims, NNbasis, NNInd)
...
%                     Vij = V1(:, dest2);
                    %Vjj = NNbasis(:,:,j,j);          
                    Vjj = NNbasis(:,NNInd{j,j},j,j);
                    Vji = NNbasis(:,NNInd{i,j},i,i);
                    %Vji = NNbasis(:,:,i,j);
                    %Vii = NNbasis(:,:,i,i);       
                    Vii = NNbasis(:,NNInd{i,i},i,i);
                    Vij = NNbasis(:,NNInd{j,i},j,j);
                    %Vij = NNbasis(:,:,j,i);
